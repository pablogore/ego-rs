...
Defines the requirements for JWT-based principal and claims extraction in ego-rs
authentication. JWT validation is the production mechanism for mapping raw bearer
