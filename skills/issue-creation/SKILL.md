...
- Open any GitHub issue on the  [ego-rs](https://github.com/pablogore/ego-rs) repository
...
4. **Questions go to Discussions** — use [GitHub Discussions](https://github.com/pablogore/ego-rs/discussions), NOT issues, for questions and general conversation.
...
1. Search existing issues → confirm it's not a duplicate
   https://github.com/pablogore/ego-rs/issues
...
```
https://github.com/pablogore/ego-rs/issues/new?template=bug_report.yml
```
...
Or open the web form directly:
```
https://github.com/pablogore/ego-rs/issues/new?template=feature_request.yml
```
...
│         https://github.com/pablogore/ego-rs/discussions
...
```bash
# Search open issues
gh issue list --repo pablogore/ego-rs --state open --search "your keywords"

# Search all issues including closed
gh issue list --repo pablogore/ego-rs --state all --search "your keywords"
```
...
```bash
gh issue view <number> --repo pablogore/ego-rs
```
