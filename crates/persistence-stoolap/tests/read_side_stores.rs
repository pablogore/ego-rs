...
//!
//! PR1 exercises only `StoolapOffsetStore`; `StoolapDedupStore` and
//! `StoolapReadSideClaimStore` land in later PRs of the same change and add
//! their own sections to this binary.

use ego_persistence_api::read_side::event_tag::EventTag;
use ego_persistence_api::read_side::offset::{Offset, OffsetStore};
use ego_persistence_stoolap::StoolapOffsetStore;
