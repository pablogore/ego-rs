...
use super::stoolap_common::{dsn_for, encode_tenant, internal_err, is_write_conflict};
...
#[cfg(test)]
mod tests {
    use super::super::stoolap_common::SYSTEMWIDE_SCOPE;
    use super::*;
    ...
    // dsn_for/encode_tenant/is_write_conflict pure-function unit tests now
    // live in `stoolap_common.rs`, alongside the promoted helpers themselves.
