...
//!
//! This is the executable specification of PLAT-009 (#484). It is `#[ignore]`d
//! because v1 does not route entities by request tenant; the issue is done when
//! this test passes with the `#[ignore]` removed and its assertions unchanged.
//!
...
#[ignore = "per-request tenant routing is not supported in v1, see #484"]
